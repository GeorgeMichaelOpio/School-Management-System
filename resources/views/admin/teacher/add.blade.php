            ...
            <form method="POST" action="" enctype="multipart/form-data">
              ...
              <div class="row">
                ...
                <div class="form-group col-md-4">
                  ...
                  <input type="date" class="form-control" value="{{ old('date_of_joining')}}" name="date_of_joining" required placeholder="Date Of Joining">
                  <div style="color: red">{{$errors->first('date_of_joining')}}</div>
                </div>
                <div class="form-group col-md-4">
                  <label for="name">Current Address<span style="color: red">*</span></label>
                  <input type="text" class="form-control" value="{{ old('address')}}" name="address" required placeholder="Current Address">
